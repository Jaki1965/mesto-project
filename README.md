...
* По замечанию ревьюера деактивирована кнопка СОХРАНИТЬ при повторном внесении данных в карточку. /commit 44 /
* Код почищен от лишних коментариев и закоментированных блоков кода. Отправляю на второе review. /commit 45/
